...
class ContactListRepository(
    ...
    suspend fun getAllContacts(): List<Contact> = withContext(Dispatchers.IO) {
        Log.d("repository.getAllContacts", "${Thread.currentThread().name}")
    ...
    private suspend fun getContactsFromCursor(cursor: Cursor): List<Contact> = withContext(
        Dispatchers.IO){
        Log.d("getContactsFromCursor", "${Thread.currentThread().name}")
    ...
    private suspend fun getPhonesForContact(contactId: Long): List<String> = withContext(Dispatchers.IO) {
        Log.d("getPhonesForContact", "${Thread.currentThread().name}")
